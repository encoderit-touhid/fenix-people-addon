...
<div class="enc-white">
    ...
    <table style="color: aliceblue !important;" id="request_service_client">
        <thead>
            <tr>
                <td>Case No</td>
                <td>Amount</td>
        ...
        <tbody>
            ...
            {
                $view_link='/my-account/submitted-service-request-single-view/?form_id='.enc_encodeContent($value->id.';'.$value->user_id);
                ?>
                <tr>
                    <td>#<?=$value->id?></td>
